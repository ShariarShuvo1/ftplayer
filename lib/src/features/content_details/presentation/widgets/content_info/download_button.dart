...
class DownloadButton extends ConsumerWidget {
  ...
  Widget _buildDownloadingButton(
    ...
    final statusColor = isActiveDownload
        ? AppColors.primary
        : (isPaused
              ? AppColors.warning
              : (isFailed
                    ? AppColors.danger
                    : (isQueued ? AppColors.textMid : AppColors.primary)));

    final statusIcon = isActiveDownload
        ? Icons.pause_rounded
        : (isPaused
      ...
      return GestureDetector(
        onTap: () async {
          ...
          if (vibrationSettings.enabled &&
              vibrationSettings.vibrateOnDownloadButton) {
    ...
    final actionText = isActiveDownload
        ? 'Pause'
        : (isPaused || isQueued ? 'Resume' : (isFailed ? 'Retry' : 'Download'));
